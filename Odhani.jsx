        ...
        <div className="hero-content">
          <div>
            ...
            <div className="hero-ctas">
              ...
              <a href="tel:+919258127600" className="btn-outline btn-icon btn-primary">📞 Call</a>
              <a href="https://wa.me/919258127600 " target="_blank" rel="noreferrer" className="btn-outline btn-icon btn-primary">💬 WhatsApp</a>
              <a href="https://www.instagram.com/odhani_theethnics/" target="_blank" rel="noreferrer" className="btn-outline btn-icon btn-primary">📸 Instagram</a>
              <a href="https://maps.app.goo.gl/rrXjw413d6ZanYB98" target="_blank" rel="noreferrer" className="btn-outline btn-icon btn-primary">📍 Location</a>
            </div>
          </div>
        </div>
      </section>
